<div >
    ...
    <form wire:submit.prevent="createProduct" class="flex flex-col justify-center ">
        <div class="mb-4">
            <label for="name" class="block text-gray-600 font-bold">Product Name:</label>
            <input wire:model="name" type="text" id="name" name="name" class="form-input shadow appearance-none border rounded  py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
